...
class PlayerView:
    ...
    def displayAllPlayers(self) -> None:
        ...
        self.controller.showMenuPlayer()

    def displayAddPlayer(self) -> None:
        """display the form to add a player"""
        new_player = self.controller.showAddPlayer()
        if new_player is None:
            self.console.print("Erreur lors de la création du joueur !")
            self.controller.showAskAddPlayer()
        else:
            table = Table(
